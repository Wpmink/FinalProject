           ...
           <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box" style="margin-left: 50px;margin-right: 50px">
                            ...
                            <form name="submitfrm" method="post" action="adminmanage.php">
                                  <div class="form-group">
                                    <a href="adminmanageTAG.php">เพิ่มข้อมูล TAG RFID</a><br>
                                    <a href="adminTAGdelete.php">ลบข้อมูล TAG RFID</a><br>
                                    <a href="adminmanagetool.php">เพิ่มข้อมูลของอุปกรณ์</a><br>
                                    <a href="adminmanageRFID.php">เพิ่ม RFID</a><br>
                                    <a href="adminRFIDdelete.php">ลบ RFID</a><br>
                                    <a href="adminmanagePLAN.php">PLAN</a><br>
                                 </div>
                            </form>
                        </div>
                    </div>
