<?php
    ...
    if (!$link) 
    {
       ...
       $sql="INSERT INTO `rfid_tooltag` (`id_tag`, `id_tool`, `id_reader`) VALUES ('$id_tag', '$id_tool' ,'$id_reader')";
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">ลงทะเบียนTAG RFID</h4> 
                        </div>
                    </div>
                </div> 
              <!--startform-->
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box" style="margin-left: 50px;margin-right: 50px">
                            <form name="submitfrm" method="post" action="adminmanageTAG.php">
                                <div class="form-group">
                                    <label>รหัสประจำอุปกรณ์</label><br>
                                    <input type="text" name="id_tag" placeholder="รหัสประจำอุปกรณ์"   id="id_tag" required=""><br>
                                    <br><label>ชื่ออุปกรณ์</label><br>
								    <input type="text" name="id_tool" placeholder="ชื่ออุปกรณ์" id="id_tool" required="" ><br>
                                    <br><label>ประเภทอุปกรณ์</label><br>
                                    <input type="text" name="id_reader" placeholder="ประเภทของอุปกรณ์"  id="id_reader" required=""><br>
                                     <br><label><button>ยืนยัน</button></label>&nbsp&nbsp&nbsp<label><input type="button" onclick="del()" value="cancel"></label>
                                </div>
                             </form>
                         </div>
                    </div>
