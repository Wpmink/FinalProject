                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">ขอต้อนรับเข้าสู่ระบบ</h4> 
                        </div>
                    </div>
                </div>
            <!--startform-->
             <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box" style="margin-left: 50px;margin-right: 50px">
                            <form name="submitfrm" method="post" action="adminmain.php">
                               
                                <table border="0"  style="width: 703px; height: 40px;">
                                <tbody><tr> 
                                  <td style="width: 21px; height: 150px;">&nbsp;</td>
                                  <td rowspan="2"  style="width: 446px; height: 150px;"> 
                                    <table border="0"  style="width: 99%; height: 175px;">
                                      <tbody>
                                          <tr> 
                                        <td style="width: 128px; height: 12px;"> <div >ชื่อผู้เข้าระบบ :</div></td>
                                        <td colspan="2" style="height: 12px">
                                            <span id="Label1" style="display:inline-block;width:448px;"><?php echo $_SESSION['firstname']." ".$_SESSION['lastname']; ?></span></td>
                                      </tr>
                                      <tr> 
                                        <td style="width: 128px; height: 12px;"> รหัสประจำตัว :</td>
                                        <td style="width: 116px; height: 12px;"><?php echo $_SESSION['id_staff']?></td>
                
                                      </tr><tr> 
                                        <td style="width: 128px; height: 12px;"> <div >แผนก :</div></td>
                                        <td colspan="2" style="height: 12px">
                                            <span id="Label1" style="display:inline-block;width:448px;"><?php echo $_SESSION['department']?></span></td>
                                      </tr>
                                      <tr> 
                                        <td style="width: 128px; height: 12px;">ตำแหน่ง :</td>
                                        <td style="width: 116px; height: 12px;"><?php echo $_SESSION['position']?></td>
                
                                      </tr>
     
                                    </tbody></table>
                                <span id="Label7" style="display:inline-block;color:#FF0066;font-family:MS Sans Serif;font-size:12pt;font-weight:bold;height:8px;width:643px;"> </span></td>
                                </tr>
                              </tbody></table>
                              </form>
                        </div>
