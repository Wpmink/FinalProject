<?php
    ...
    if (!$link) 
    {
       ...
       if($_SERVER["REQUEST_METHOD"]=="POST")
       {
           ...
           $sql = "SELECT * FROM rfid_staff WHERE id_staff ='".$id_staff."'";
           $result = mysqli_query($link,$sql); 

           if($result == 1 )
           {
                 phpAlert("ลบข้อมูลสำเร็จ");
                 $sql="DELETE FROM rfid_staff WHERE id_staff = '".$id_staff."'";
                 $result = mysqli_query($link,$sql);
            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                   <li>
                    ...
                    <li>
                        <a href="adminmanage.html" class="waves-effect"><i class="fa fa-columns fa-fw"></i><span class="hide-menu">จัดการอุปกรณ์</span></a>
                    </li>
                    <li>
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">ลบข้อมูลพนักงาน</h4> 
                        </div>
                    </div>
                </div> 
         <!--startform-->     
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box" style="margin-left: 50px;margin-right: 50px">
                            <form name="submitfrm" method="post" action="admindeletehuman.php">
                                <div class="form-group">
                                     <input type="text" name="id_staff" placeholder="รหัสประจำตัว"   id="id_staff" required="">
								     <br><br><input type="text" name="firstname" placeholder="ชื่อ"   id="firstname" required="">
