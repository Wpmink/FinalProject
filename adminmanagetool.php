                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">เพิ่มอุปกรณ์</h4> 
                        </div>
                    </div>
                </div> 
        <!-- Page Content -->    
                        ...
                        <div class="white-box" style="margin-left: 50px;margin-right: 50px">
                            <form name="submitfrm" method="post" action="adminprofile.php">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="id_tool" placeholder="รหัสประจำตัวอุปกรณ์"   id="id_tool" required=""><br>
                                    <br><label>ชื่ออุปกรณ์</label><br>
								    <input type="text" name="name_tool" placeholder="ชื่ออุปกรณ์" id="lastname" required="" ><br>
                                    <br><label>ID TAG</label><br>
                                    <input type="text" name="id_tag" placeholder="รหัสประจำTag"   id="ID_staff" required="">
