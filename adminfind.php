                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box" style="margin-left: 50px;margin-right: 50px">
                            <form name="submitfrm" method="post" action="adminfind.php">
                                <div class="form-group">
							        <label>ID TAG </label><br>
								        <input type="text" name="code" placeholder="รหัสอุปกรณ์"   id="code" required="">
							    </div>

                                <div class="form-group">
							        <label>ชื่ออุปกรณ์</label><br>
								        <input type="text" name="name" placeholder="ชื่ออุปกรณ์"   id="name" required="">
							    </div>
                                <button>ค้นหา</button>
                            </form>
                        </div>
