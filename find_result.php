                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">ผลการค้นหา</h4> 
                        </div>
                    </div>
                </div>
            <!--startform-->
               <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box" style="margin-left: 50px;margin-right: 50px">
                            <form name="submitfrm" method="post" action="find_result.php">
                                <div class="form-group">
                                    <?php
		                                    ...
		                                    echo "<center><table border='1' width=60% height=20%>
				                                    <tr>
                                                    <th><center>รหัสประจำอุปกรณ์</center></th>
			                                    ...
			                                    echo "<tr>";
                                                echo "<td><center>" . $result['id_tool'] . "</center></td>";
			                                    echo "<td><center>" . $result['name_tool'] . "</center></td>";
			                                    echo "<td><center>" . $result['category'] . "</center></td>";
                                                echo "<td><center>" . $result['department'] . "</center></td>"; 
			                                    echo "</tr>";
