<?php
    ...
    if (!$link) 
    {
       ...
       if($_SERVER["REQUEST_METHOD"]=="POST")
       {
           ...
           $sql = "SELECT * FROM rfid_reader WHERE id_reader ='".$id_reader."' and room = '".$room."'";
           $result = mysqli_query($link,$sql); 

           if($result == 1 )
           {
                 $sql="DELETE FROM rfid_reader WHERE id_reader = '".$id_reader."' and room = '".$room."'";
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">ลบอุปกรณ์RFID</h4> 
                        </div>
                    </div>
                </div> 
         <!--startform-->     
                 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box" style="margin-left: 50px;margin-right: 50px">
                            <form name="submitfrm" method="post" action="adminRFIDdelete.php">
